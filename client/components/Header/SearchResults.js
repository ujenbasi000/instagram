...
const SearchResults = () => {
  return (
    <div className="absolute z-40 left-1/2 -translate-x-1/2 top-[50px] bg-white border border-gray-200 shadow-md rounded-md">
      <div
        className="search_results_arrow z-10
      absolute -top-2 left-1/2 w-4 h-4 bg-white border-gray-200"
      />
      <div className="h-64 w-80 relative z-20">
